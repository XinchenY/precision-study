...
**EN** — Every number in the write-up can be traced along
*table → provenance ledger (`logs/mhd/ch10_runs.csv`) → CSV/cmp file →
original command*. Section 1 gives the full build matrix (all compile
